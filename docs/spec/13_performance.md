...
> 워커 수·옵션 상세는 `09_service_design.md` §1 Gunicorn 행 + `docs/research/backend/02_app_server.md` §4.1 참조. 운영 토폴로지는 `09_service_design.md` §11 참조.
...
> 캐시 대상·TTL·무효화 시점·전략 상세: 09_service_design.md 섹션 9
...
> 배치 실행 시각 기준: 04_feature_spec.md 섹션 10

| 배치 종류 | 시작 | 완료 목표 | 허용 시간 | 단계 |
|----------|------|----------|----------|------|
| 야간 예측 배치 (매일) | 02:00 | 05:00 이전 | 3시간 | [MVP] |
| 주간 재학습 배치 (일요일) | 02:00 | 06:00 이전 | 4시간 | [2단계] (`03_mvp_scope.md` §4) |
